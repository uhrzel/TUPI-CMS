<style>/* Blinking animation */
/* Blinking and shadow animation */
@keyframes blink_shadow {
    0% {
        opacity: 1;
        box-shadow: 0 0 5px rgba(255, 0, 0, 0.7); /* Initial shadow */
    }
    50% {
        opacity: 0;
        box-shadow: 0 0 10px rgba(255, 0, 0, 0.7); /* Larger shadow */
    }
    100% {
        opacity: 1;
        box-shadow: 0 0 5px rgba(255, 0, 0, 0.7); /* Initial shadow */
...
.blink_me {
    animation: blink_shadow 1s infinite; /* Blinking and shadow animation */
    color: #fff;
...
<?php } ?>
    ...
    <a href="replies.php">
        ...
        ?>
												...
												<li>
							    <a href="urgent_identification.php">
    ...
    <a href="sms_notifications.php">
        ...
        if ($result) {
            ...
            echo '<span class="badge badge-danger ml-auto">' . $totalUsersWithContactNo . '</span>';
        } else {
