										...
										<tbody>
											...
											?>
												...
												?>
													<!-- <tr>
<td><b>Remark</b></td>
<td colspan="5"><?php echo  htmlentities($rw['complaintType']); ?> <b>Remark Date :</b><?php echo  htmlentities($rw['rdate']); ?></td>
</tr> -->
												...
												<tr>
													...
													<td>
														<?php if ($row['status'] == "closed") {
															...
															<a href="javascript:void(0);" onClick="popUpWindow('http://localhost:8080/cms/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']); ?>');" title="Update order">
																<button type="button" class="btn btn-primary">Take Action</button>
													</td>
													</a><?php } ?></td>
												<td colspan="4">
													<a href="javascript:void(0);" onClick="popUpWindow('http://localhost:8080/cms/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']); ?>');" title="Update order">
